...
$sanphamct = $data["sanphamct"];

$formatted_price = number_format($sanphamct[0]['giaban'], 0, '.', ',');
?>
            ...
            <div class="col-lg-6">
                <div class="s_Product_carousel">
                    <div class="single-prd-item">
                        <img class="img-fluid" src="img/<?= $sanphamct[0]['hinhanh'] ?>" alt="">
                    </div>
                    <div class="single-prd-item">
                        <img class="img-fluid" src="img/<?= $sanphamct[0]['hinhanh'] ?>" alt="">
                    </div>
                ...
                <div class="s_product_text">
                    ...
                    <form action="index.php?pg=addcart" method="post">
                        <div class="product_count">
                            ...
                            <input type="hidden" value="0" name="idkh">
                            <input type="hidden" value="<?= $sanphamct[0]['id'] ?>" name="id">
                            <input type="hidden" value="<?= $sanphamct[0]['tensp'] ?>" name="name">
                            <input type="hidden" value="<?= $sanphamct[0]['hinhanh'] ?>" name="img">
                            <input type="hidden" value="<?= $sanphamct[0]['giaban'] ?>" name="price">

                            <label for="shoe_size">Chọn kích thước giày:</label><br>
                            <select name="size" id="shoe_size" value="<?=$sanphamct[0]['sizemin']?>">
                                <?php
                                $size_min = $sanphamct[0]['sizemin'];
                                $size_max = $sanphamct[0]['sizemax'];

                                // Tạo danh sách các kích thước giày từ size nhỏ nhất đến lớn nhất
                            ...
                            <input type="number" name="soluong" id="sst" maxlength="12" value="1" title="Quantity:"
                                class="input-text qty">
                        </div>
                        <div class="card_area d-flex align-items-center">
                            <button type="submit" name="addcart" value="Add to Cart"
                                style="border: none; background-color: transparent; cursor: pointer; outline: none;">
                                <p class="primary-btn">Thêm vào giỏ hàng</p>
                            </button>
                        </div>
                    </form>
                    <ul class="list">
                        <li><a class="active" href="#"><span>Hãng Giày</span> : Household</a></li>
                        <li><a href="#"><span>Sản Xuất</span> : In Stock</a></li>
                    </ul>
                    <p>
                        <?= $sanphamct[0]['mota'] ?>
                    </p>
